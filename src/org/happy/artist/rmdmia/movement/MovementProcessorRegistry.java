...
/**
 * org.happy.artist.rmdmia.rcsm.MovementProcessorRegistry class is implemented by the MovementProcessorManager 
 ...
 * 
 */
public class MovementProcessorRegistry 
{
    ...
    // 
    private static String strRulesFileName = "conf/movement_processors.eax";     
    // Singleton instance of MovementProcessorRegistry
    private static MovementProcessorRegistry movementProcessorRegistry; 
    // 
    
    // Set the MovementProcessorRegistry to private for singleton control.
    private MovementProcessorRegistry()
    {
        // Implement SortedMap to get MovementProcessor Arrays in sorted order.
        MovementProcessorRegistry.props = new SortedEAProperties(new MovementProcessorRegistry.HardwareIDKeyComparator());
    ...
    public final static MovementProcessorRegistry getInstance()
    {
        if(movementProcessorRegistry!=null)
        {
            return MovementProcessorRegistry.movementProcessorRegistry;
        }
        return MovementProcessorRegistry.movementProcessorRegistry = new MovementProcessorRegistry();
    }
    ...
    {
        // Test the MovementProcessorRegistry...
        MovementProcessorRegistry.getInstance();
    }
