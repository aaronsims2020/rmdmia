...
/**
 * org.happy.artist.rmdmia.rcsm.SensorProcessorRegistry class is implemented by the SensorProcessorManager 
 ...
 * 
 */
public class SensorProcessorRegistry 
{
    ...
    // 
    private static String strRulesFileName = "conf/pe/ros/sensor_message_queue.eax";     
    // Singleton instance of SensorProcessorRegistry
    private static SensorProcessorRegistry sensorProcessorRegistry; 
    // 
    
    // Set the SensorProcessorRegistry to private for singleton control.
    private SensorProcessorRegistry()
    {
        // Implement SortedMap to get MovementProcessor Arrays in sorted order.
        SensorProcessorRegistry.props = new SortedEAProperties(new SensorProcessorRegistry.HardwareIDKeyComparator());
    ...
    public final static SensorProcessorRegistry getInstance()
    {
        if(sensorProcessorRegistry!=null)
        {
            return SensorProcessorRegistry.sensorProcessorRegistry;
        }
        return SensorProcessorRegistry.sensorProcessorRegistry = new SensorProcessorRegistry();
    }
    ...
    {
        // Test the SensorProcessorRegistry...
        SensorProcessorRegistry.getInstance();
    }
