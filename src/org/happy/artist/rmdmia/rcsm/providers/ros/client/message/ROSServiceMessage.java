 ...
 */
public class ROSServiceMessage 
{
    ...
    public ROSServiceMessage(String callerid, String md5sum,boolean tcp_nodelay, String service, String type, boolean persistent) throws UnsupportedEncodingException
    {
