...
/** DefaultPersistentServiceMessageHandler.java The default ROS Service 
 * Message Handler for Persistent Service Connections. The Persistent version 
 * of  the Service Message Handler has better performance than the default 
 * Service Message Handler due to it not needing to check if the connection is
 * persistent every time it receives a message.
 ...
 */
public class DefaultPersistentServiceMessageHandler implements MessageHandlerInterface
{
