...
/** org.happy.artist.rmdmia.utilities.ros.BagOutputStream - Create, and add
 *  ROS messages in the ROS BagOutputStream format to a bag document. Output Plugin framework
 ...
 * 
 */
public class BagRandomAccessFile 
{ 
    // getInstance method variables.
    private static BagRandomAccessFile singleton;
...
// start method variables.    
    ...
    public void start(String file_path, int COMPRESSION_TYPE) throws IOException
    {
        ...
        if(COMPRESSION_TYPE==BagRandomAccessFile.CHUNK_COMPRESSION_BZ2)
        {
...
;
    ...
    /** Return singleton instance of BagRandomAccessFile. */
    public static BagRandomAccessFile getInstance()
    {
        if(singleton==null)
        {
            BagRandomAccessFile.singleton = new BagRandomAccessFile();
        }
        return BagRandomAccessFile.singleton;
    }
    ...
    public synchronized void addConnectionHeader(char[] topic, int conn, char[] connection_header_hex) throws IOException
    {
        ...
        connection_header_sb.append(createHexField(CONNECTION_TOPIC_KEY, BagRandomAccessFile.stringToHex(String.valueOf(topic))));       
        ...
        connection_header_sb.append(createHexField(CONNECTION_CONN_KEY, BagRandomAccessFile.bytesToHex(conn_array)));
        ...
        connection_header_sb.insert(0,BagRandomAccessFile.bytesToHex(conn_array)); 
    ...
    public synchronized void addMessage(long time, int conn, char[] message_data_hex) throws IOException
    {
        ...
        message_data_header_sb.append(createHexField(MESSAGE_DATA_TIME_KEY, BagRandomAccessFile.bytesToHex(message_data_time_array)));
        // conn header field
        ...
        message_data_header_sb.append(createHexField(MESSAGE_DATA_CONN_KEY, BagRandomAccessFile.bytesToHex(message_data_conn_array)));
        ...
        // insert the header length into the header
        message_data_header_sb.insert(0,BagRandomAccessFile.bytesToHex(message_data_conn_array)); 
        // append message_data
    ...
    private String createBagHeader(long index_pos_length, int conn_count, int chunk_count)
    {
        ...
        bag_header_sb.append(createHexField(INDEX_POS_LENGTH_KEY, BagRandomAccessFile.bytesToHex(index_pos_length_array)));
        ...
        bag_header_sb.append(createHexField(CONN_COUNT_KEY, BagRandomAccessFile.bytesToHex(connection_count_array)));
        ...
        bag_header_sb.append(createHexField(CHUNK_COUNT_KEY, BagRandomAccessFile.bytesToHex(connection_count_array)));
        ...
        // insert the header length into the header
        bag_header_sb.insert(0,BagRandomAccessFile.bytesToHex(connection_count_array));      
    ...
    private void padBagHeader() 
    {
        ...
        bag_header_sb.append(BagRandomAccessFile.bytesToHex(padding_length_bytes));                
        // append padding
...
// TODO: Handle Size field based on compression type.        
        ...
        chunk_header_sb.append(createHexField(CHUNK_SIZE_KEY, BagRandomAccessFile.bytesToHex(chunk_size_array)));
        // Re-using sb_header_length (this may need to be separated in the future... If it is called in an non-synchronous manner.
        ...
        // insert the header length into the header
        chunk_header_sb.insert(0,BagRandomAccessFile.bytesToHex(chunk_size_array));
    ...
    private String createHexField(char[] hex_field_name, char[] hex_field_value)
    {
        ...
        hex.insert(0, BagRandomAccessFile.bytesToHex(field_length_bytes));
        return hex.toString();
    }
    ...
    private String createHexField(char[] hex_field_name, String hex_field_value)
    {
        ...
        str_hex.insert(0, BagRandomAccessFile.bytesToHex(str_field_length_bytes));
    ...
    {
        BagRandomAccessFile bag = new BagRandomAccessFile();
        System.out.println("Bag Header: ".concat(bag.createBagHeader(((long)878657565), 256, 7))); 
    // TODO: Implement and test with BZ2 support.
        System.out.println("Chunk Header: ".concat(bag.createChunkHeader(BagRandomAccessFile.CHUNK_COMPRESSION_NONE, 0)));
    }      
