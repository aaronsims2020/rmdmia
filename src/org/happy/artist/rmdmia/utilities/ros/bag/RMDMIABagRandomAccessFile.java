 ...
 * 
 */
public class RMDMIABagRandomAccessFile 
{ 
    // getInstance method variables.
    private static RMDMIABagRandomAccessFile singleton;
...
// start method variables.    
    ...
    public synchronized void start(String file_path, int COMPRESSION_TYPE) throws IOException
    {
        ...
        if(COMPRESSION_TYPE==RMDMIABagRandomAccessFile.CHUNK_COMPRESSION_BZ2)
        {
...
;
        try
        {
            file.write(HexToBytes.hexToBytes(sb.toString()));
        }
        catch(IOException e)
        {
            throw e;
    ...
    public static RMDMIABagRandomAccessFile getInstance()
    {
        if(singleton==null)
        {
            RMDMIABagRandomAccessFile.singleton = new RMDMIABagRandomAccessFile();
        }
        return RMDMIABagRandomAccessFile.singleton;
    }
    ...
    public synchronized void addConnectionHeader(char[] topic, int conn, char[] connection_header_hex) throws IOException
    {
        ...
        connection_header_sb.append(createHexField(CONNECTION_TOPIC_KEY, RMDMIABagRandomAccessFile.stringToHex(String.valueOf(topic))));       
        ...
        connection_header_sb.append(createHexField(CONNECTION_CONN_KEY, RMDMIABagRandomAccessFile.bytesToHex(conn_array)));
        ...
        connection_header_sb.insert(0,RMDMIABagRandomAccessFile.bytesToHex(conn_array)); 
        // Append Connection Message Header Data to Connection Header 
        connection_header_sb.append(connection_header_hex);        
        file.write(HexToBytes.hexToBytes(connection_header_sb.toString()));
    }
    ...
    {
        System.out.println("Calling addMessage... ");
        // clear the current StringBuilder
        ...
        message_data_header_sb.append(createHexField(MESSAGE_DATA_TIME_KEY, RMDMIABagRandomAccessFile.bytesToHex(message_data_time_array)));
        // conn header field
        ...
        message_data_header_sb.append(createHexField(MESSAGE_DATA_CONN_KEY, RMDMIABagRandomAccessFile.bytesToHex(message_data_conn_array)));
        ...
        // insert the header length into the header
        message_data_header_sb.insert(0,RMDMIABagRandomAccessFile.bytesToHex(message_data_conn_array)); 
        // append message_data
        message_data_header_sb.append(message_data_hex);
        System.out.println("Calling addMessage... file.write ");
        file.write(HexToBytes.hexToBytes(message_data_header_sb.toString()));
    ...
    private String createBagHeader(long index_pos_length, int conn_count, int chunk_count)
    {
        ...
        bag_header_sb.append(createHexField(INDEX_POS_LENGTH_KEY, RMDMIABagRandomAccessFile.bytesToHex(index_pos_length_array)));
        ...
        bag_header_sb.append(createHexField(CONN_COUNT_KEY, RMDMIABagRandomAccessFile.bytesToHex(connection_count_array)));
        ...
        bag_header_sb.append(createHexField(CHUNK_COUNT_KEY, RMDMIABagRandomAccessFile.bytesToHex(connection_count_array)));
        ...
        // insert the header length into the header
        bag_header_sb.insert(0,RMDMIABagRandomAccessFile.bytesToHex(connection_count_array));      
    ...
    private void padBagHeader() 
    {
        ...
        bag_header_sb.append(RMDMIABagRandomAccessFile.bytesToHex(padding_length_bytes));                
        // append padding
...
// TODO: Handle Size field based on compression type.        
        ...
        chunk_header_sb.append(createHexField(CHUNK_SIZE_KEY, RMDMIABagRandomAccessFile.bytesToHex(chunk_size_array)));
        // Re-using sb_header_length (this may need to be separated in the future... If it is called in an non-synchronous manner.
        ...
        // insert the header length into the header
        chunk_header_sb.insert(0,RMDMIABagRandomAccessFile.bytesToHex(chunk_size_array));
    ...
    private String createHexField(char[] hex_field_name, char[] hex_field_value)
    {
        ...
        hex.insert(0, RMDMIABagRandomAccessFile.bytesToHex(field_length_bytes));
        return hex.toString();
    }
    ...
    private String createHexField(char[] hex_field_name, String hex_field_value)
    {
        ...
        str_hex.insert(0, RMDMIABagRandomAccessFile.bytesToHex(str_field_length_bytes));
    ...
    {
        RMDMIABagRandomAccessFile bag = new RMDMIABagRandomAccessFile();
        System.out.println("Bag Header: ".concat(bag.createBagHeader(((long)878657565), 256, 7))); 
    // TODO: Implement and test with BZ2 support.
        System.out.println("Chunk Header: ".concat(bag.createChunkHeader(RMDMIABagRandomAccessFile.CHUNK_COMPRESSION_NONE, 0)));
    }      
